    ...
    return (
        <nav id="nav" className="w-[100%] z-10 sticky top-0 py-2 lg:py-0 pl-4 flex items-center justify-between lg:justify-start bg-yellow-400 text-[16px]">
            ...
            <div className="lg:hidden pr-4 relative text-xl sm:text-3xl">
                ...
                <i className="fa-solid fa-magnifying-glass mx-4 cursor-pointer" onClick={toggleSearch}></i>
                <Search show={search}/>
                <i className="fa-solid fa-bars cursor-pointer" onClick={toggleNavbar}></i>
            </div>
            <div className={`navlinks ${navbar ? "hidden" : "absolute lg:static left-0 top-[43px] block min-h-[100vh] lg:min-h-fit w-[250px] lg:w-auto bg-white"} lg:mt-4 lg:pl-6 lg:pr-4 lg:py-2 lg:flex-grow lg:flex lg:items-center lg:justify-between lg:rounded-tl-full lg:bg-white`}>
                ...
                <div class="hidden lg:inline">
                    <i className="fa-lg fa-solid fa-magnifying-glass cursor-pointer" onClick={toggleSearch}></i>
                    <Search show={search}/>
