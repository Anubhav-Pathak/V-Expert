    ...
    return (
        <div id="services">       
            <section className='service min-h-screen w-full overflow-hidden flex items-center justify-center'>
                <div className='max-w-[1400px] py-12 px-4 flex flex-col lg:flex-row lg:gap-8 md:place-items-center'>
                    <div className='text-blue bg-white border-2 border-blue p-4 rounded-lg'>
