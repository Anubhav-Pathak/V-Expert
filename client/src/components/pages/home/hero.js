...
const Hero = () => {
  return (
    <section className="relative">
        <HeroCarousel />
        <div className={"hero absolute top-0 left-0 z-10 min-h-full w-full sm:min-w-[50%] sm:max-w-3xl py-4 px-16 text-white flex flex-col items-center justify-center sm:items-start text-center sm:text-left"}>
